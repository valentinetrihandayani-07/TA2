...
<?php include('session.php'); ?>
    <body id="class_div">
        ...
        <div class="container-fluid">
                     ...
                     <div class="row-fluid">
					    <!-- breadcrumb -->	
					     <ul class="breadcrumb">
								...
								?>
								<li><a href="#"><b>Pengumuman</b></a><span class="divider">/</span></li>
			...
			<div class="alert alert-info">Tandai Kelas yang ingin Anda taruh file ini.</div>
						...
						<?php } ?>
								...
								<hr>
									...
									<div class="control-group">
												<div class="controls">
													<button name="Upload" type="submit" value="Upload" class="btn btn-success" /><i class="icon-check"></i>&nbsp;Tambah</button>
												</div>
									</div>
									</center>
