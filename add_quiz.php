                     ...
                     <div class="row-fluid">
					    <!-- breadcrumb -->	
									<ul class="breadcrumb">
										...
										<li><a href="#"><b>Tambah Quiz</b></a></li>
									</ul>
						 <!-- end breadcrumb -->
                        <!-- block -->
                        <div id="block_bg" class="block">
                            ...
                            <div class="block-content collapse in">
                                <div class="span12">
									...
									<a href="teacher_quiz.php" class="btn btn-info"><i class="icon-arrow-left"></i> Kembali</a>
									</div>
								
									    <form class="form-horizontal" method="post">
										<div class="control-group">
											<label class="control-label" for="inputEmail">Judul Quiz</label>
											<div class="controls">
											<input type="text" name="quiz_title" id="inputEmail" placeholder="Judul Quiz">
											</div>
										</div>
										<div class="control-group">
											<label class="control-label" for="inputPassword">Deskripsi Quiz</label>
											<div class="controls">
											<input type="text" class="span8" name="description" id="inputPassword" placeholder="Deskripsi Quiz" required>
											</div>
										</div>										
										<div class="control-group">
										<div class="controls">										
