                     ...
                     <div class="row-fluid">
					    <!-- breadcrumb -->	
									<ul class="breadcrumb">
										...
										<li><a href="#"><b>Tambah Quiz ke Kelas</b></a></li>
									</ul>
						 <!-- end breadcrumb -->
                        <!-- block -->
                            ...
                            <div class="block-content collapse in">
                                <div class="span12">
									...
									<a href="teacher_quiz.php" class="btn btn-info"><i class="icon-arrow-left"></i> Kembali</a>
										...
										<div class="control-group">
											<label class="control-label" for="inputPassword">Waktu Quiz (menit)</label>
											<div class="controls">
											<input type="text" class="span3" name="time" id="inputPassword" placeholder="Waktu Quiz" required>
											</div>
										</div>
