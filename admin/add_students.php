                        ...
                        <div class="block">
                            ...
                            <div class="block-content collapse in">
								...
								<form id="add_student" method="post">
										...
										<div class="control-group">
                                          <div class="controls">
                                            <input name="un" class="input focused" id="focusedInput" type="text" placeholder = "ID Siswa" required>
                                          </div>
                                        </div>
										
										<div class="control-group">
                                          <div class="controls">
                                            <input name="fn" class="input focused" id="focusedInput" type="text" placeholder = "Nama Depan" required>
                                          </div>
                                        </div>
										
										<div class="control-group">
                                          <div class="controls">
                                            <input  name="ln" class="input focused" id="focusedInput" type="text" placeholder = "Nama Belakang" required>
                                          </div>
                                        </div>
											...
											<div class="control-group">
                                          <div class="controls">
												<button name="save" class="btn btn-info">Simpan</button>
