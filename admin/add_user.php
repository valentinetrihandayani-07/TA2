   <div class="row-fluid">
                        ...
                        <div class="block">
                            <div class="navbar navbar-inner block-header">
                                <div class="muted pull-left">Tambah Admin</div>
                            </div>
                            <div class="block-content collapse in">
								...
								<form method="post">
										<div class="control-group">
                                          <div class="controls">
                                            <input class="input focused" name="firstname" id="focusedInput" type="text" placeholder = "Nama Depan" required>
                                          </div>
                                        </div>
										...
										<div class="control-group">
                                          <div class="controls">
											...
											<div class="control-group">
                                          <div class="controls">
												<button name="save" class="btn btn-info">Simpan</i></button>
