            ...
            <div class="row-fluid">
				<?php include('subject_sidebar.php'); ?>
						...
						<div class="span9" id="content">
		                    <div class="row-fluid">
									 <a href="add_subject.php" class="btn btn-info"><i class="icon-plus-sign icon-large"></i> Tambah Mata Pelajaran</a>
		                        <!-- block -->
		                        <div id="" class="block">
		                            <div class="navbar navbar-inner block-header">
		                                <div class="muted pull-left">Edit Mata Pelajaran</div>
		                            </div>
									...
									?>
										...
										<button name="update" type="submit" class="btn btn-info"><i class="icon-save icon-large"></i> Simpan</button>
										</div>
										</div>
										</form>
