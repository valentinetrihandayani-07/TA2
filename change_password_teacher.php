                     ...
                     <div class="row-fluid">
                        ...
                        <div id="block_bg" class="block">
                            <div class="navbar navbar-inner block-header">
                            	  <div id="" class="muted pull-right"><a href="profile_teacher.php"><i class="icon-arrow-left"></i> Kembali</a></div>
                                ...
                                <div class="span12">
  								...
  								<div class="alert alert-info"><i class="icon-info-sign"></i> Silakan Isi detail yang diperlukan</div>
								<?php
								...
								?>					
								    ...
								    <form  method="post" id="change_password" class="form-horizontal">
										<div class="control-group">
											...
											<label class="control-label" for="inputEmail">Password Sekarang</label>
											<div class="controls">
											<input type="hidden" id="password" name="password" value="<?php echo $row['password']; ?>"  placeholder="Current Password">
											<input type="password" id="current_password" name="current_password"  placeholder="Password Sekarang">
											</div>
										</div>
										<div class="control-group">
