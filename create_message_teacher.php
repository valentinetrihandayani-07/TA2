				      ...
				      <!-- block -->
                        <div class="block">
                            <div class="navbar navbar-inner block-header">
                                <div id="" class="muted pull-left"><h4><i class="icon-pencil"></i> Menulis Pesan</h4></div>
                            </div>
                            <div class="block-content collapse in">
                                <div class="span12">
									<ul class="nav nav-tabs">
										<li>
											<a href="teacher_message.php">Untuk Guru</a>
										</li>
										<li class="active"><a href="teacher_message_teacher.php">Untuk Siswa</a></li>
									</ul>
								...
								<form method="post" id="send_message_student">
									<div class="control-group">
										...
										<div class="control-group">
                                          <div class="controls">
												<button  class="btn btn-info"><i class="icon-envelope-alt"></i> Kirim </button>
