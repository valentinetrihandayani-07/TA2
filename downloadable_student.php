                     ...
                     <div class="row-fluid">
					    <!-- breadcrumb -->
					     ...
					     <ul class="breadcrumb">
							...
							<li><a href="#"><b>Download Materi</b></a></li>
						</ul>
						 <!-- end breadcrumb -->
                        ...
                        <div id="block_bg" class="block">
							...
							?>
							    <div id="" class="muted pull-left"><h4> Progres latihan QUIZ</h4></div>
							...
							Pilih Semua <input type="checkbox"  name="selectAll" id="checkAll" /> -->
								...
								<?php
									...
									$count = mysqli_num_rows($query);	
								if ($count == '0'){ ?>
								<div class="alert alert-info"><i class="icon-info-sign"></i>Tidak ada materi yang dapat diunduh yang saat ini diunggah.</div>
								<?php
								}else{
								?>
