				<!-- user delete modal -->
					...
					<h3 id="myModalLabel">Hapus Quiz</h3>
					</div>
					<div class="modal-body">
					<div class="alert alert-danger">
					<p>Apakah Anda yakin ingin Hapus Quiz di kelas yang Anda tandai ini?</p>
					</div>
					</div>
					<div class="modal-footer">
					<button class="btn" data-dismiss="modal" aria-hidden="true"><i class="icon-remove icon-large"></i> Tutup</button>
					<button name="backup_delete" class="btn btn-danger"><i class="icon-check icon-large"></i> Iya</button>
					</div>
					</div>