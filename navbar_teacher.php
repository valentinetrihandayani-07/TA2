	<div class="navbar navbar-fixed-top navbar-inverse">
           <div class="navbar-inner">
               <div class="container-fluid">
                   ...
                   <a class="brand" href="#">LMS SMAN 1 Simanindo</a>
												...
												<li class="dropdown">
													<a href="#" role="button" class="dropdown-toggle" data-toggle="dropdown"> <i class="icon-user icon-large"></i><?php echo $row['firstname']." ".$row['lastname'];  ?> <i class="caret"></i></a>
															<ul class="dropdown-menu">
																<li>
																	<!-- <a href="change_password_teacher.php"><i class="icon-circle"></i> Ubah Passsword</a>
																	<a tabindex="-1" href="#myModal" data-toggle="modal"><i class="icon-picture"></i> Ubah Profile</a> -->
																	<a tabindex="-1" href="profile_teacher.php"><i class="icon-user"></i>Edit Profil</a>
																</li>
																<li class="divider"></li>
