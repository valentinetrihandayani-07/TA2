                     ...
                     <div class="row-fluid">
					    <!-- breadcrumb -->	
					     <ul class="breadcrumb">
								...
								<li><a href="#"><b>Kirim Pesan</b></a><span class="divider">/</span></li>
                        ...
                        <div id="block_bg" class="block">
                            ...
                            <div class="block-content collapse in">
                                <div class="span12">
										...
										<li class=""><a href="student_message.php"><i class="icon-envelope-alt"></i>Pesan Masuk</a></li>
										<li class="active"><a href="sent_message_student.php"><i class="icon-envelope-alt"></i>Kirim Pesan</a></li>
										</ul>
								...
								<?php }}else{ ?>
								<div class="alert alert-info"><i class="icon-info-sign"></i> Tidak ada pesan terkirim </div>
								<?php } ?>	
                                </div>
                            </div>
                        </div>
