							...
							Tandai Semua <input type="checkbox"  name="selectAll" id="checkAll" />
								...
								$("#checkAll").click(function () {
									$('input:checkbox').not(this).prop('checked', this.checked);
										...
										<li class="active"><a href="student_message.php"><i class="icon-envelope-alt"></i>Pesan Masuk</a></li>
										<li class=""><a href="sent_message_student.php"><i class="icon-envelope-alt"></i>Kirim Pesan</a></li>
										</ul>
