            ...
            <div class="row-fluid">
                ...
                <div class="span9" id="content">
                     <div class="row-fluid">
						...
						?>
							<li><a href="#"><b>Notifikasi</b></a><span class="divider">/</span></li>
  					...
  					<form action="read.php" method="post">
						<?php if($not_read == '0'){
							...
							<button id="delete"  class="btn btn-info" name="read"><i class="icon-check"></i> Baca</button>
					...
					?>
					<div class="alert alert-info"><strong><i class="icon-info-sign"></i> Tidak Ada Pemberitahuan Ditemukan</strong></div>
					<?php
					}
					?>
