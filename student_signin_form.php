			...
			<h3 class="form-signin-heading"><i class="icon-lock"></i> Registrasi Siswa </h3>
			<input type="text" class="input-block-level" id="username" name="username" placeholder="ID Siswa" required>
			...
			jQuery("#signin_student").submit(function(e){
					...
					$.ajax({
						...
						if(html=='true')
						{
						$.jGrowl("Welcome to LMS SMAN 1 Simanindo", { header: 'Sign up Success' });
						var delay = 2000;
			...
			<a onclick="window.location='index.php'" id="btn_login" name="login" class="btn" type="submit"><i class="icon-signin icon-large"></i> Klik untuk Login</a>
