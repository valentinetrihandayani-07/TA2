...
?>
<br/>
<button onclick="return false;" qn="<?php echo $x;?>" class="nextq btn btn-success" id="next_<?php echo $x;?>">PERTANYAAN SELANJUTNYA <i class="icon-arrow-right"></i> </button>
...
<td></td>
<td>
<button class="btn btn-info" id="submit-test" name="submit_answer"><i class="icon-check"></i> Submit Jawaban</button>
...
<?php
	...
	<a href="student_quiz_list.php<?php echo '?id='.$get_id; ?>"><i class="icon-arrow-left"></i> Kembali</a>
	<center>
	<h3><br>Score anda <b><?php echo $score; ?></b> dari <b><?php echo ($x-1); ?></b><br/></h3>
	</center>
	<?php
