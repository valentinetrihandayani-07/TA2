                     ...
                     <div class="row-fluid">
					   ...
					   <!-- breadcrumb -->
					     ...
					     <ul class="breadcrumb">
							...
							<li><a href="#"><b>Tugas yang Diunggah</b></a></li>
						</ul>
						 <!-- end breadcrumb -->
                        ...
                        <div id="block_bg" class="block">
                            <div class="navbar navbar-inner block-header">
                                <div id="" class="muted pull-right"><a href="assignment.php<?php echo '?id='.$get_id; ?>"><i class="icon-arrow-left"></i> Kembali</a></div>
                            </div>
                            <div class="block-content collapse in">
                                <div class="span12">
									...
									?>
									<div class="alert alert-info">Serahkan Tugas di : <?php echo $row1['fname']; ?></div>
